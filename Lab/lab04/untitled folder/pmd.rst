      ...
      000003 02 00 83         [24]  347 	ljmp	_main
                                    ...
                                    358 ;------------------------------------------------------------
                                    359 ;	pmd.c:12: void delay_ms(unsigned int s){
                                    360 ;	-----------------------------------------
      ...
      000082 22               [24]  400 	ret
                                    ...
                                    405 ;------------------------------------------------------------
                                    406 ;	pmd.c:24: void main(){
                                    407 ;	-----------------------------------------
                                    408 ;	 function main
                                    409 ;	-----------------------------------------
      000083                        410 _main:
                                    411 ;	pmd.c:28: ENLED = 0;
                                    412 ;	assignBit
      000083 C2 94            [12]  413 	clr	_P1_4
                                    414 ;	pmd.c:29: ADDR3 = 1;
                                    415 ;	assignBit
      000085 D2 93            [12]  416 	setb	_P1_3
                                    417 ;	pmd.c:30: ADDR2 = 1;
                                    418 ;	assignBit
      000087 D2 92            [12]  419 	setb	_P1_2
                                    420 ;	pmd.c:31: ADDR1 = 1;
                                    421 ;	assignBit
      000089 D2 91            [12]  422 	setb	_P1_1
                                    423 ;	pmd.c:32: ADDR0 = 0;
                                    424 ;	assignBit
      00008B C2 90            [12]  425 	clr	_P1_0
                                    426 ;	pmd.c:34: while(1){ //主循环
      00008D                        427 00104$:
                                    428 ;	pmd.c:36: P0 = 0xff;
      00008D 75 80 FF         [24]  429 	mov	_P0,#0xff
                                    430 ;	pmd.c:38: delay_ms(150);
      000090 90 00 96         [24]  431 	mov	dptr,#0x0096
      000093 12 00 62         [24]  432 	lcall	_delay_ms
                                    433 ;	pmd.c:40: for(i = 0;i<8;i++){
      000096 7F 00            [12]  434 	mov	r7,#0x00
      000098                        435 00106$:
                                    436 ;	pmd.c:41: P0 = P0 <<1;
      000098 E5 80            [12]  437 	mov	a,_P0
      00009A 25 E0            [12]  438 	add	a,acc
      00009C F5 80            [12]  439 	mov	_P0,a
                                    440 ;	pmd.c:42: delay_ms(150);
